...
class Furnish extends React.Component {
  ...
  onDragStop(event, draggableData, furnishId) {
      console.log(draggableData.x, draggableData.y);
      console.log(furnishId);
      // Update data.
  }
     ...
     return (
          <Draggable
              ...
              onStop={ (event, draggableData) => {
                this.onDragStop(event, draggableData, furnish.furnishid);
              }}
